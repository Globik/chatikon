...
<head>${html_head.html_head({
		...
		title: `${n.lang ?'Продать токены за биткоины':'Sell tokens for bitcoin'}`,
		meta:
			get_meta({
...
<main id="pagewrap">
    ${icons_menu.icons_menu({current:'btc', user:buser, ln: n.lang })}
    <h1>${n.lang?'Продать токены за биткоины':'Sell tokens for bitcoin'}</h1>
</main>
