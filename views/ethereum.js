...
<head>${html_head.html_head({
		...
		title: `${n.lang?'Продать токены за эфиры':'Sell tokens for ethereum'}`,
		meta:
			get_meta({
...
<main id="pagewrap">
    ${icons_menu.icons_menu({current:'eth', user:buser, ln: n.lang })}
    <h1>${n.lang?'Продать токены за эфиры':'Sell tokens for ethereum'}</h1>
</main>
